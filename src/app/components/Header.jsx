  ...
  return (
    ...
    ">
      ...
      <div className="flex items-center space-x-2 sm:space-x-4">
        {/* Búsqueda Desktop (visible desde tablet en adelante) */}
        ...
        {/* Mi Tienda Button - SIEMPRE VISIBLE */}
        <button className="
        ...
        ">
          ...
          <span className="hidden xs:inline sm:inline">Mi tienda</span>
        </button>
      </div>

      {/* Búsqueda Móvil Expandible (cuando showSearch = true) */}
      {showSearch && (
        <div className="md:hidden absolute top-full left-0 right-0 bg-gray-900 p-4 shadow-lg border-t border-gray-700">
