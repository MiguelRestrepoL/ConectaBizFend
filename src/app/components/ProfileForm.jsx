        ...
        <form onSubmit={handleSubmitProfile}>
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-3 md:px-4 py-2 md:py-3 bg-gray-100 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm md:text-base"
            />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full sm:w-auto bg-gray-600 hover:bg-gray-700 text-white px-6 py-2 rounded-lg transition-colors disabled:opacity-50 text-sm md:text-base"
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                value={user.email || formData.primary_email}
                readOnly
                className="w-full px-3 md:px-4 py-2 md:py-3 bg-gray-100 rounded-lg text-gray-900 text-sm md:text-base"
              />
            </div>
            <button
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-3 md:px-4 py-2 md:py-3 bg-gray-100 rounded-lg text-gray-900 placeholder-gray-500 text-sm md:text-base"
              />
            </div>
            <button
